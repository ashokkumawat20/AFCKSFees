...
public class TemplateDisplayActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        takeChangeCourses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!preferences.getString("user_id", "").equals("")) {
                    Intent intent = new Intent(TemplateDisplayActivity1.this, TabsFragmentActivity.class);
        ...
        takeChangeLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!preferences.getString("user_id", "").equals("")) {
                    Intent intent = new Intent(TemplateDisplayActivity1.this, Activity_Location_Details.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(getApplicationContext(), "Please select student from list", Toast.LENGTH_LONG).show();
                }
        ...
        takeChangedayprefrence.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!preferences.getString("user_id", "").equals("")) {
                    Intent intent = new Intent(TemplateDisplayActivity1.this, Activity_DayPrefrence_Display.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(getApplicationContext(), "Please select student from list", Toast.LENGTH_LONG).show();
                }
        ...
        takeChangeHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!preferences.getString("user_id", "").equals("")) {
                    finish();
                    Intent intent = new Intent(TemplateDisplayActivity1.this, StudentList.class);
                    startActivity(intent);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TemplateDisplayActivity1.this, AddTemplateContactsActivity.class);
                startActivity(intent);
    ...
    public void addTextListener() {
        ...
        search.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence query, int start, int before, int count) {
                ...
                mleadList.setLayoutManager(new LinearLayoutManager(TemplateDisplayActivity1.this));
                templateListAdpter = new TemplateListAdpter(TemplateDisplayActivity1.this, filteredList);
    ...
    private class getCoursesList extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(TemplateDisplayActivity1.this);
        ...
        protected void onPostExecute(Void args) {
            if (templateListResponse.compareTo("") != 0) {
                templateListAdpter = new TemplateListAdpter(TemplateDisplayActivity1.this, data);
                mleadList.setAdapter(templateListAdpter);
                mleadList.setLayoutManager(new LinearLayoutManager(TemplateDisplayActivity1.this));
