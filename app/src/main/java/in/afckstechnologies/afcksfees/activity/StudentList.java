...
public class StudentList extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        notestxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!batch_id.equals("")) {
                    Intent intent = new Intent(StudentList.this, UpcomingClassDetailsActivity.class);
            ...
            public void onClick(View v) {
                ...
                if (studentMobileNoArrayList.size() > 0) {
                    if (!batch_id.equals("")) {
                        ...
                        DatePickerDialog dpd = new DatePickerDialog(StudentList.this,
...
// We need to get the instance of the LayoutInflater
            LayoutInflater inflater = (LayoutInflater) StudentList.this
    ...
    public void forceUpdate() {
        ...
        new ForceUpdateAsync(currentVersion, StudentList.this).execute();
                                ...
                                if (verifyMobileDeviceIdResponse.compareTo("") == 0) {
                                    ...
                                    try {
                                        ...
                                        if (status) {
                                            ...
                                            prefEditor.commit();
                                            Intent intent = new Intent(StudentList.this, TrainerVerfiyActivity.class);
                                            startActivity(intent);
                                        }
                                    } catch (JSONException e) {
                                        // TODO Auto-generated catch block
...
//
    ...
    class SendingMailsTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            // TODO Auto-generated method stub
            super.onPreExecute();
            dialog = ProgressDialog.show(StudentList.this, "Marking Attendance " + (count++) + " / " + studentMobileNoArrayList.size(), "Please wait...", true);
            dialog.show();
        }
